...
\begin{figure}[H]
    \centering
    \includegraphics[0.5\linewidth]{img/storetog.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[0.5\linewidth]{img/hfile_map.png}
\end{figure}
...
HDFS is a Java-based file system utilized for storing large data sets.                            & HBase is a Java based Not Only SQL database                                       \\ \hline
HDFS has a rigid architecture that does not allow changes. It doesn’t facilitate dynamic storage. & HBase allows for dynamic changes and can be utilized for standalone applications. \\ \hline
HDFS is ideally suited for write-once and read-many times use cases                               & HBase is ideally suited for random write and read of data that is stored in HDFS. \\ \hline
\end{tabular}
\end{table}
...
\begin{figure}
    \centering
    \includegraphics{img/ondisk_hbase.png}
\end{figure}
